...
#include "GeometrySB/Public/BaseGeometryActor.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	GEOMETRYSB_API UEnum* Z_Construct_UEnum_GeometrySB_EMovementType();
	UPackage* Z_Construct_UPackage__Script_GeometrySB();
	GEOMETRYSB_API UScriptStruct* Z_Construct_UScriptStruct_FGeometryData();
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FLinearColor();
	GEOMETRYSB_API UClass* Z_Construct_UClass_ABaseGeometryActor_NoRegister();
	GEOMETRYSB_API UClass* Z_Construct_UClass_ABaseGeometryActor();
...
// End Cross Module References
	static UEnum* EMovementType_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_GeometrySB_EMovementType, Z_Construct_UPackage__Script_GeometrySB(), TEXT("EMovementType"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EMovementType(EMovementType_StaticEnum, TEXT("/Script/GeometrySB"), TEXT("EMovementType"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_GeometrySB_EMovementType_Hash() { return 4137970799U; }
	UEnum* Z_Construct_UEnum_GeometrySB_EMovementType()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_GeometrySB();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EMovementType"), 0, Get_Z_Construct_UEnum_GeometrySB_EMovementType_Hash(), false);
#else
...
class UScriptStruct* FGeometryData::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern GEOMETRYSB_API uint32 Get_Z_Construct_UScriptStruct_FGeometryData_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FGeometryData, Z_Construct_UPackage__Script_GeometrySB(), TEXT("GeometryData"), sizeof(FGeometryData), Get_Z_Construct_UScriptStruct_FGeometryData_Hash());
	}
	return Singleton;
}
template<> GEOMETRYSB_API UScriptStruct* StaticStruct<FGeometryData>()
{
	return FGeometryData::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FGeometryData(FGeometryData::StaticStruct, TEXT("/Script/GeometrySB"), TEXT("GeometryData"), false, nullptr, nullptr);
static struct FScriptStruct_GeometrySB_StaticRegisterNativesFGeometryData
{
	FScriptStruct_GeometrySB_StaticRegisterNativesFGeometryData()
	{
		UScriptStruct::DeferCppStructOps<FGeometryData>(FName(TEXT("GeometryData")));
	}
} ScriptStruct_GeometrySB_StaticRegisterNativesFGeometryData;
	...
	uint32 Get_Z_Construct_UScriptStruct_FGeometryData_Hash() { return 3344098955U; }
	...
	IMPLEMENT_CLASS(ABaseGeometryActor, 4030494359);
	template<> GEOMETRYSB_API UClass* StaticClass<ABaseGeometryActor>()
	{
		return ABaseGeometryActor::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ABaseGeometryActor(Z_Construct_UClass_ABaseGeometryActor, &ABaseGeometryActor::StaticClass, TEXT("/Script/GeometrySB"), TEXT("ABaseGeometryActor"), false, nullptr, nullptr, nullptr);
